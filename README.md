...
С этим файлом скрипт выдает ошибку

Используй силу скачать ЭТОТ файл папку должен ты wget -nd https://github.com/JeffTrain/selfie/raw/master/shape_predictor_68_face_landmarks.dat
